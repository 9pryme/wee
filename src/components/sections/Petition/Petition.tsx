...
export function Petition() {
  ...
  return (
    <section className="min-h-screen relative pb-20 sm:pb-32">
      {/* Background Image */}
      ...
      <div className="relative z-10 container mx-auto px-4 py-10 sm:py-20">
        ...
        <div className="bg-white rounded-[20px] sm:rounded-[32px] border-2 sm:border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] sm:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] px-4 sm:px-10 py-6 sm:py-8 bg-[url('/images/bank-bg.png')] bg-cover bg-center mb-8 sm:mb-12">
          <div className="max-w-[1200px] mx-auto">
            <motion.div
              ...
              className="mb-8"
            >
              <h4 className="text-2xl sm:text-3xl md:text-[48px] leading-[1.1] font-montserrat text-gray-900 font-extrabold italic tracking-[-0.03em] max-w-[600px] mx-auto text-center">
                We want you to <br />
                publicly commit to
              </h4>
            </motion.div>
